...
![pando reopening the last workspace, the project switcher, and Add project completing a path](docs/demo/projects.gif)
...
![the find widget, typing, save through gofmt, and a new untitled file](docs/demo/edit.gif)
...
![an editor in vim mode: motions, dd and u, a visual selection, gofmt on save](docs/demo/vim.gif)
...
![the terminal under the editor, then a session docked right of it and left of it](docs/demo/panels.gif)
